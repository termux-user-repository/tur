...
TERMUX_PKG_DEPENDS="libcairo, gcr, glib, gtk4, gperf, json-glib, krb5, libdb, libical, libsoup3, libuuid, libxml2, libnspr, libnss, openldap, libsecret, libsqlite, pango, webkit2gtk-4.1, webkitgtk-6.0"
