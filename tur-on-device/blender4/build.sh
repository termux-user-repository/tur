...
TERMUX_PKG_DEPENDS="alembic, brotli, desktop-file-utils, ffmpeg, fftw, freetype, glew, hicolor-icon-theme, libandroid-execinfo, libandroid-posix-semaphore, libblosc, libepoxy, libpng, libpugixml, libraw, libsndfile, libspnav, libtiff, openal-soft, opencolorio, openexr, openimageio, openjpeg, openvdb, potrace, ptex, python, python-numpy, python-pip, sdl2, shaderc, shared-mime-info, sse2neon"
