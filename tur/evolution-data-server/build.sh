...
TERMUX_PKG_DEPENDS="libcairo, glib, gtk4, json-glib, krb5, libcanberra, libdb, libical, libsoup3, libuuid, libxml2, libnspr, libnss, openldap, libsqlite, webkit2gtk-4.1, webkitgtk-6.0"
