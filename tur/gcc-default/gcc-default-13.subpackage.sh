...
TERMUX_SUBPKG_BREAKS="gcc-default-9, gcc-default-10, gcc-default-11, gcc-default-12, gcc-default-14, gcc-default-15"
TERMUX_SUBPKG_CONFLICTS="gcc-default-9, gcc-default-10, gcc-default-11, gcc-default-12, gcc-default-14, gcc-default-15"
TERMUX_SUBPKG_INCLUDE="share/$TERMUX_PKG_NAME/.placeholder-13"

termux_step_create_subpkg_debscripts() {
	local _GCC_DEFAULT_VERSION=13
