TERMUX_PKG_HOMEPAGE=https://repo.dichvucoder.vn
...
termux_step_make_install() {
	...
	echo "deb https://repo.dichvucoder.vn dvc-packages dvc" > $TERMUX_PREFIX/etc/apt/sources.list.d/dichvucoder.list
	## dvc gpg key
