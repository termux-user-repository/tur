...
termux_step_make_install() {
    # Create the system directory layout for your application files
    mkdir -p "$TERMUX_PREFIX/share/lite-ide"
    cp -r "$TERMUX_PKG_SRCDIR/tur/lite-ide/"* "$TERMUX_PREFIX/share/lite-ide/"

    # Create an executable launcher shortcut script in the system path
