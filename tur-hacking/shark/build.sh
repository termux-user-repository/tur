...
TERMUX_PKG_DEPENDS="curl, wget, php, unzip, 7zip, ncurses-utils, proot, resolv-conf, sox, ffmpeg, dialog"
TERMUX_PKG_ANTI_BUILD_DEPENDS="curl, wget, php, unzip, 7zip, ncurses-utils, proot, resolv-conf, sox, ffmpeg, dialog"
